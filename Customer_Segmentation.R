...
raw.data <- read.csv("Online Retail.csv", stringsAsFactors = FALSE)
head(raw.data)
...
customers$cum <- cumsum(customers$monetary)
customers$pareto <- ifelse(customers$cum <= pareto.cutoff, "Top 20%", "Bottom 80%")
